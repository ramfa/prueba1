...
import Asignatura.GrillaAsignatura;


import Categoria.NuevaCategoria;
import Comision.GrillaComision;
import Comision.Nuevacom;
import Docente.GrillaDocente;
...
public class Menu1 extends javax.swing.JFrame {
   ...
   private boolean estacerrado(Object obj){
    ...
    private void initComponents() {
        ...
        jButton7.setText("4 - Planta Docente Ideal");
        ...
        jPanel2.setBounds(140, 120, 420, 280);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Login/utn_frt_logoSup.jpg"))); // NOI18N
        escritorio.add(jLabel1);
        jLabel1.setBounds(200, 30, 320, 70);

        getContentPane().add(escritorio, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 690, 460));
    ...
    NuevoEmpleado e = new NuevoEmpleado();
    escritorio.add(e);
    e.setVisible(true);
